      ...
      <View style={[style.row, style.container]}>
        ...
        <View style={style.content}>
          <View style={[style.row, style.between, style.dis]}>
            <Text style={style.name}>产品名字</Text>
            <Text style={style.name}>¥4000</Text>
          </View>
          <Text style={[style.dis, style.label]}>
            需购买量 <Text style={style.num}> 5</Text>
          </Text>
          <Text style={[style.dis, style.label]}>
            实购买量 <Text style={style.num}> 5</Text>
          </Text>
          <Text style={[style.dis, style.label]}>
            售价
            <Text style={style.num}> ¥900</Text>
          </Text>
          <View style={[style.row, style.between]}>
            <View style={[style.btn, style.upBtn]}>
              <Text style={[style.btnContent, style.upContent]}>更新</Text>
            </View>
